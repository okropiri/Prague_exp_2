if (!exists("infile")) infile = "ch2_parent_time_tot_no_modulo_hist2d.dat"
if (!exists("outfile")) outfile = "ch2_parent_time_tot_no_modulo_hist2d.png"
if (!exists("plot_title")) plot_title = "NCAL ch2 TOT vs time since parent ch0, no modulo"
if (!exists("xmin")) xmin = 0
if (!exists("xmax")) xmax = 45
...
set xlabel "time since parent ch0 [us]"
