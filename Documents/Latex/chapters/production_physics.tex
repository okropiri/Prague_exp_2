...
Consequently, a \SI{30}{MeV} neutron used later for analytical time-of-flight reference plots should be read as a representative fast-neutron scale within the high-energy part of the forward spectrum, not as a statement that the source is monoenergetic at \SI{30}{MeV}. The thick-target reference spectrum extends to about \SI{33}{MeV}, while the prominent high-energy structure lies near \SIrange{30}{32}{MeV}; lower-energy continuum neutrons are also present and will arrive later than the \SI{30}{MeV} reference curve.
